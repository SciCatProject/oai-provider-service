...
import { ScicatPanoscMapper } from "../scicat-provider/repository/scicat-panosc-mapper";
 ...
 */
const provider = new CoreOaiProvider(factory, new Configuration(), new ScicatPanoscMapper());
